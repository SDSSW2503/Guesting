...
public class MemberService {
	...
	public MemberRes signIn(Integer memberId, String password) {
		Member member = memberRepository.getByMemberId(memberId).orElseThrow(()->new CustomException("일치하는 아이디가 없습니다."));
	...
	public MemberRes getMyInfo(Integer memberId) {
		Member member = memberRepository.getByMemberId(memberId).orElseThrow(()->new CustomException("유효하지 않은 멤버 아이디입니다."));
